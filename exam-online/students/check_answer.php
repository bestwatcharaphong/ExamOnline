	               ...
	               <div class="navbar-header">
					...
					<?php
						if($row_user['role'] == 2) {			/*สำหรับนักศึกษา*/
		  				  	   ...
		  				  	   if(isset($_POST['set_id']) && isset($_POST['subject_id'])){
					?>
				 ...
				 <div class="nav navbar-default" role="navigation">
						 <div id="sidebar-wrapper" class="sidebar-toggle" align="center">
							 <ul class="sidebar-nav">
								 ...
								 <li class="sidebar-selected"><a href="#">คะแนนที่ได้</a></li>
				  		   ...
				  		   <h1 align="center" style="font-size: 25px;">คะแนนที่ได้</h1><br>
				  <?php
						   ...
						   while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
							   ...
							   if(isset($_POST[$row['exam_id']])){				/*กรณีส่งคำตอบมาครบ*/
								   $choice_selected = mysqli_real_escape_string($conn, $_POST[$row['exam_id']]);
							   }else{											/*กรณีส่งคำตอบมาไม่ครบเมื่อเวลาหมดก่อนทำข้อสอบเสร็จ*/
								   $choice_selected = 6;
							   }
							   if($choice_selected == $row['answer_key']){
								   $score++;
							   }
							   $all_question++;
						   ...
						   echo "<br>";
						   echo "<h2 align=center  style=\"font-size: 20px;\">คุณทำข้อสอบได้ " . $score . " / " . $all_question ." คะแนน</h2><br>";

						   $query_score = "UPDATE score SET score = $score WHERE user_id = '$user_id' AND set_id = $set_id";
					 ...
					 ?>
					   <br>
					   <div align="center">
						   <a href="set_student.php?subject_id=<?php echo $subject_id; ?>" class="btn btn-default glyphicon glyphicon-chevron-left back"> กลับ</a>
					   </div>
