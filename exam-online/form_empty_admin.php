<?php
	...
	require 'connectdb.php';						/*สำหรับ admin อาจารย์และนักศึกษาที่เข้าสู่ระบบแล้ว */
...
<body style="overflow: visible; height: initial; color: #000; color: rgba(0,0,0,1.0);" class="Design fp-responsive fp-viewing-Ecommerce">
	        ...
	        <div class="col-xs-6 col-sm-7 col-md-7 wrap_menu-z">
	           <div class="menubar">
	               ...
	               <div class="navbar-header">
					...
					<?php
						if($row_user['role'] == 0) {			/*สำหรับ admin*/
					?>
